...
public class ChangeColorIconWithText extends View
{
                                   ...
                                   int defStyleAttr)
	{
		...
		for (int i = 0; i < n; i++)
		{
			...
			if (attr == R.styleable.ChangeColorIconWithText_myicon) {
				BitmapDrawable drawable = (BitmapDrawable) a.getDrawable(attr);
				mIconBitmap = drawable.getBitmap();

			} else if (attr == R.styleable.ChangeColorIconWithText_mycolor) {
				mColor = a.getColor(attr, 0xFF3cafff);

			} else if (attr == R.styleable.ChangeColorIconWithText_text) {
	...
	{
		mTextPaint.setColor(0xffa1a4a6);
